...
def main():
    ...
    parser.add_argument('--optim_type', type=str, default='adam',
                        help='opimizer type')
    parser.add_argument('--epochs_o', type=int, default=2000,
    ...
    center = center_bounds[0,:] + torch.rand(args.parm_size,dim) * (
        center_bounds[1,:]-center_bounds[0,:])
    u0_inlet = u0_inlet_bounds[0] + torch.rand(args.parm_size) * (
