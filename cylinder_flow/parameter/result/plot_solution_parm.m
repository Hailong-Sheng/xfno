...
geo.center = [-0.5,-0.1]; geo.radius = 0.2;
...
c_x1 = te_set_prd(:,1); c_x2 = te_set_prd(:,2); c_a = te_set_prd(:,3);
c_u1_prd = te_set_prd(:,5); c_u2_prd = te_set_prd(:,6); c_p_prd = te_set_prd(:,7);
c_u1_ref = te_set_ref(:,5); c_u2_ref = te_set_ref(:,6); c_p_ref = te_set_ref(:,7);
c_mask = te_set_prd(:,8);

idx = 1;
mesh.c_x1 = c_x1((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_x2 = c_x2((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_u1_prd = c_u1_prd((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_u2_prd = c_u2_prd((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_p_prd = c_p_prd((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_u1_ref = c_u1_ref((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_u2_ref = c_u2_ref((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
mesh.c_p_ref = c_p_ref((idx-1)*mesh.c_size+1:idx*mesh.c_size,:);
